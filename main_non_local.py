...
n_points_used_for_dynamics = 100 #How many points are available from which to infer dynamics
...
n_hidden_tangent = 8 #How many nodes in hidden layer that learns tangent plane
n_hidden_int = 8 #How many nodes in hidden layer that learns intrinsic dynamics
########################################################################################################################
