...
iso_embedding_true_sp = mds.fit(dist_mat_true_geo).embedding_.T
iso_embedding_measured_sp = mds.fit(dist_mat_measured_geo).embedding_.T
iso_embedding_true = mds.fit(dist_mat_true_geo).embedding_.T
iso_embedding_measured = mds.fit(dist_mat_measured_geo).embedding_.T
#iso_embedding_true_sp = mds.fit(dist_mat_true_flat, weight=dist_mat_true_flat_wgt).embedding_.T
#iso_embedding_true_sp = mds.fit(dist_mat_true_trimmed, weight=(dist_mat_true_trimmed != 0).astype(int), init=iso_embedding_true_sp).embedding_.T
...
print_process(iso_embedding_local, bounding_shape=None, color_map=color_map_clusters_2, titleStr="Isomap with Locally Learned Intrinsic Metric", align_points=intrinsic_process_clusters_2)
stress, stress_normlized = embbeding_score(intrinsic_process_clusters_2, iso_embedding_local, titleStr="Isomap with Locally Learned Intrinsic Metric", n_points=n_points_used_for_clusters_2)
print('iso_embedding_local:', stress_normlized)

print_process(iso_embedding_true_sp, bounding_shape=None, color_map=color_map_clusters_2, titleStr="Isomap with Exact Short Distances", align_points=intrinsic_process_clusters_2)
stress, stress_normlized = embbeding_score(intrinsic_process_clusters_2, iso_embedding_true_sp, titleStr="Isomap with Exact Short Distances", n_points=n_points_used_for_clusters_2)
...
stress, stress_normlized = embbeding_score(intrinsic_process_clusters_2, iso_embedding_measured_sp, titleStr="Regular Isomap", n_points=n_points_used_for_clusters_2)
print('iso_embedding_measured_sp:', stress_normlized)

print_process(iso_embedding_true, bounding_shape=None, color_map=color_map_clusters_2, titleStr="PCA on Intrinsic Space")
stress, stress_normlized = embbeding_score(n_points_used_for_clusters_2, iso_embedding_true, titleStr="PCA on Intrinsic Space", n_points=n_points_used_for_clusters_2)
print('iso_embedding_true:', stress_normlized)

print_process(iso_embedding_measured, bounding_shape=None, color_map=color_map_clusters_2, titleStr="PCA on Measured Space")
stress, stress_normlized = embbeding_score(intrinsic_process_clusters_2, iso_embedding_measured, titleStr="PCA on Measured Space", n_points=n_points_used_for_clusters_2)
...
stress, stress_normlized = embbeding_score(n_points_used_for_clusters_2, diff_embedding_local, titleStr="Diffusion Maps with Locally Learned Intrinsic Metric")
...
stress, stress_normlized = embbeding_score(n_points_used_for_clusters_2, diff_embedding_true_sp, titleStr="Diffusion Maps with Exact Short Distances")
...
stress, stress_normlized = embbeding_score(n_points_used_for_clusters_2, diff_embedding_true, titleStr="Diffusion Maps on Intrinsic Space", n_points=n_points_used_for_clusters)
...
stress, stress_normlized = embbeding_score(n_points_used_for_clusters_2, diff_embedding_measured_sp, titleStr="Regular Diffusion Maps")
...
stress, stress_normlized = embbeding_score(n_points_used_for_clusters_2, diff_embedding_measured, titleStr="Diffusion Maps on Measured Space", n_points=n_points_used_for_clusters)
